...
public class CreateCardsForPanels : MonoBehaviour
{
    [ContextMenu("Create Cards")]
    public void CreateCards()
    {
        // Create cards for SunumlarPanel
        CreateCardsForPanel("sinif/UI_Canvas/FuturisticPanel/GlassContainer/ContentRoot/SunumlarPanel", "Sunum", "Sunum İçeriği");

        // Create cards for VideolarPanel
        CreateCardsForPanel("sinif/UI_Canvas/FuturisticPanel/GlassContainer/ContentRoot/VideolarPanel", "Video", "Video İçeriği");

        Debug.Log("Cards created successfully!");
    }

    private void CreateCardsForPanel(string panelPath, string cardPrefix, string description)
    {
    ...
    private void CreateCard(Transform parent, string cardName, string title, string description)
    {
